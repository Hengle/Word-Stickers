Shader "Custom/DropShadow_Mobile"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_frag out_f;
          u_xlat0.xy = (in_f.vs_TEXCOORD1.xy + (-float2(_OffsetX, _OffsetY)));
          u_xlat0.xy = ((u_xlat0.xy * _MobileBlur_ST.xy) + _MobileBlur_ST.zw);
          u_xlat10_0 = tex2D(_MobileBlur, u_xlat0.xy);
          u_xlat16_0.xyz = (u_xlat10_0.xyz * in_f.vs_COLOR0.xyz);
          u_xlat1.xyz = (u_xlat16_0.xyz * float3(_Lightness, _Lightness, _Lightness));
          u_xlat1.x = dot(u_xlat1.xyz, float3(0.298999995, 0.587000012, 0.114));
          u_xlat0.xyz = ((u_xlat16_0.xyz * float3(_Lightness, _Lightness, _Lightness)) + (-u_xlat1.xxx));
          float _tmp_dvx_33 = float3(_Saturation, _Saturation, _Saturation);
          out_f.SV_Target0.xyz = ((float3(_tmp_dvx_33, _tmp_dvx_33, _tmp_dvx_33) * u_xlat0.xyz) + u_xlat1.xxx);
