  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_frag frag(IN_Data_Frag in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MaskTex, in_f.vs_TEXCOORD0.zw).w;
          u_xlat0 = ((-u_xlat10_4) + u_xlat0);
          u_xlat4.x = ((-_MaskWipeControl) + 1);
          ...
          u_xlat10_4 = tex2D(_MainTex, in_f.vs_TEXCOORD0.xy).w;
          u_xlat16_1 = ((u_xlat10_4 * in_f.vs_TEXCOORD1.x) + (-in_f.vs_TEXCOORD1.w));
          u_xlat16_1 = clamp(u_xlat16_1, 0, 1);
          u_xlat16_5 = (u_xlat16_1 * in_f.vs_COLOR0.w);
          u_xlat16_2.xyz = (float3(u_xlat16_5, u_xlat16_5, u_xlat16_5) * _MaskEdgeColor.xyz);
          u_xlat3.w = (u_xlat0 * u_xlat16_5);
          u_xlat16_4.xyz = ((in_f.vs_COLOR0.xyz * float3(u_xlat16_1, u_xlat16_1, u_xlat16_1)) + (-u_xlat16_2.xyz));
          u_xlat4.xyz = ((float3(u_xlat0, u_xlat0, u_xlat0) * u_xlat16_4.xyz) + u_xlat16_2.xyz);
          u_xlat3.xyz = (float3(u_xlat0, u_xlat0, u_xlat0) * u_xlat4.xyz);
          out_f.SV_Target0 = u_xlat3;
          return out_f;
          1;
          0;
      }
