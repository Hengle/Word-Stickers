...
namespace GameAnalyticsSDK.Wrapper
{
	public class GA_Wrapper
	{
		...
		private static void initialize(string gamekey, string gamesecret)
		{
			...
			new AndroidJavaClass("com.gameanalytics.sdk.GAPlatform").CallStatic("initializeWithActivity", @static);
		...
		{
			return GA.CallStatic<string>("getCommandCenterValueAsString", new object[2]
			{
				key,
				defaultValue
			});
		...
		{
			return GA.CallStatic<bool>("isCommandCenterReady", Array.Empty<object>());
		}

		private static string getConfigurationsContentAsString()
		{
			return GA.CallStatic<string>("getConfigurationsContentAsString", Array.Empty<object>());
		}
