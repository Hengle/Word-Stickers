Shader "Custom/GaussianBlur_Mobile"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_frag out_f;
          u_xlat0.xy = (_MainTex_TexelSize.zw / _ScreenParams.xy);
          u_xlat0.xy = (u_xlat0.xy * _MainTex_TexelSize.xy);
          u_xlat0.xy = (((-u_xlat0.xy) * float2(0.5, 0.5)) + in_f.vs_TEXCOORD2.xy);
          ...
          float _tmp_dvx_35 = float3(_Saturation, _Saturation, _Saturation);
          out_f.SV_Target0.xyz = ((float3(_tmp_dvx_35, _tmp_dvx_35, _tmp_dvx_35) * u_xlat0.xyz) + u_xlat1.xxx);
